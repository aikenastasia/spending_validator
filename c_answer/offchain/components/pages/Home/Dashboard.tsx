    ...
    Cip68: {
      mint: async (nft: { name: string; image: string }) => {
        try {
          ...
          submitTx(tx)
            .then((result) => {
              localStorage.setItem("spend_answer.cip68_policyid", policyID);
              localStorage.setItem("spend_answer.cip68_assetname", assetName);
      ...
      update: async (nft: { name: string; image: string }) => {
        try {
          ...
          const policyID = localStorage.getItem("spend_answer.cip68_policyid");
          const assetName = localStorage.getItem("spend_answer.cip68_assetname");
      ...
      burn: async () => {
        try {
          ...
          submitTx(tx)
            .then((result) => {
              localStorage.removeItem("spend_answer.cip68_policyid");
              localStorage.removeItem("spend_answer.cip68_assetname");
              props.setActionResult(result);
            })
            .catch(props.onError);
        } catch (error) {
